...
I apply the same analytical rigor to [evaluating CRE deals with code](https://zacharyvorsteg.com/blog/why-im-a-commercial-real-estate-broker-who-codes/) and [running 54 trading bot strategies](https://zacharyvorsteg.com/blog/algorithmic-trading-bots-side-project/). The [context engineering layer](https://zacharyvorsteg.com/blog/context-engineering-ai-agents/) orchestrates how AI assists the analysis, the [vibe coding framework](https://zacharyvorsteg.com/blog/vibe-coding-vs-real-engineering/) determines which code gets full review, and [agentic AI](https://zacharyvorsteg.com/blog/how-i-use-agentic-ai-one-person-company/) handles the operational throughput. The [agentic engineering methodology](https://zacharyvorsteg.com/blog/agentic-engineering-patterns/) governs how I work with AI agents in each session, and [what actually breaks at scale](https://zacharyvorsteg.com/blog/what-breaks-when-you-automate-everything/) keeps me honest about automation's limits. For the [$8/month automation stack](https://zacharyvorsteg.com/blog/my-solo-founder-automation-stack/) underneath it all and the philosophy behind working this way, see [how I build in public](https://zacharyvorsteg.com/blog/how-i-build-in-public-as-a-technical-founder/). Explore [what I'm working on](https://zacharyvorsteg.com/#work) or [reach out](https://zacharyvorsteg.com/#contact).
